package com.baghdad.tudee.ui.shared.components.taskDetailsBottomSheet
...
import com.baghdad.tudee.designSystem.components.VerticalSeparatorLine
...
fun TaskDetailsBottomSheet(
    ...
    TudeeBottomSheet(
        ...
        TaskDetailsContent(
            ...
            icon = task.category?.let { getCategoryIconPainter(it.image) }
                ?: painterResource(R.drawable.ic_green_plant),
